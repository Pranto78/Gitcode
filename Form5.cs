    ...
    public partial class Form5 : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
...

            {
                ...
                query = "insert into newStudent  (mobile,name,fname,mname,email,paddress,college,idproof,roomNo) values (" + mobile + ",'" + name + "','" + father + "', '" + mother + "', '" + email + "', '" + permanent + "', '" + college + "', '" + id + "', " + room + ")  update rooms set Booked = 'Yes' where roomNo = " + room + "";
